...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InformacionEstablecimientoPageModule", function() { return InformacionEstablecimientoPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__informacion_establecimiento__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_google_maps__ = __webpack_require__(271);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_servicio_buscar_servicio_buscar__ = __webpack_require__(270);
...
var InformacionEstablecimientoPageModule = (function () {
    function InformacionEstablecimientoPageModule() {
    }
    return InformacionEstablecimientoPageModule;
}());
InformacionEstablecimientoPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__informacion_establecimiento__["a" /* InformacionEstablecimientoPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__informacion_establecimiento__["a" /* InformacionEstablecimientoPage */]),
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_3__ionic_native_google_maps__["a" /* GoogleMaps */],
            __WEBPACK_IMPORTED_MODULE_4__providers_servicio_buscar_servicio_buscar__["a" /* ServicioBuscarProvider */]
        ]
    })
], InformacionEstablecimientoPageModule);

//# sourceMappingURL=informacion-establecimiento.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return LatLng; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_observable_fromEvent__ = __webpack_require__(195);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InformacionEstablecimientoPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(97);
...
var InformacionEstablecimientoPage = (function () {
    function InformacionEstablecimientoPage(navCtrl, navParams, googleMaps, platform, loadingCtrl, alertCtrl, servicioBuscar) {
    ...
    InformacionEstablecimientoPage.prototype.ionViewDidLoad = function () {
        this.latLng = new __WEBPACK_IMPORTED_MODULE_2__ionic_native_google_maps__["c" /* LatLng */](this.est.Latitud, this.est.Longitud);
        if (this.esMovil) {
    ...
    InformacionEstablecimientoPage.prototype.cargarEstablecimiento = function (id) {
        var _this = this;
        var loader = this.loadingCtrl.create({
            content: "Cargando..."
        });
        loader.present();
        this.servicioBuscar.getEstablecimientoPorId(id).then(function (data) {
            if (data == null) {
                _this.mostrarMensajeError("No se pudo obtener el establecimiento, intertar mas tarde");
                loader.dismiss();
                return;
            }
            _this.est = data;
    ...
    InformacionEstablecimientoPage.prototype.mostrarMensajeError = function (mensaje) {
    ...
    InformacionEstablecimientoPage.prototype.moverCamara = function (latLng) {
        this.map.moveCamera({
            target: latLng
        });
    };
    InformacionEstablecimientoPage.prototype.cargarMapaMovil = function () {
        var _this = this;
        var mapOptions = {
            camera: {
                target: {
        ...
        this.map.one(__WEBPACK_IMPORTED_MODULE_2__ionic_native_google_maps__["b" /* GoogleMapsEvent */].MAP_READY)
            .then(function () {
            _this.moverCamara(_this.latLng);
            _this.añadirMarcador(_this.latLng);
        })
            .catch(function (error) {
            console.log(error);
        });
    };
    InformacionEstablecimientoPage.prototype.añadirMarcador = function (latLng) {
        if (this.esMovil) {
            this.map.addMarker({
    ...
    InformacionEstablecimientoPage.prototype.initMap = function () {
        var mapOptions = {
            center: this.latLng,
            zoom: 15,
    ...
    return InformacionEstablecimientoPage;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* ViewChild */])('mapa'),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* ElementRef */])
], InformacionEstablecimientoPage.prototype, "mapElement", void 0);
InformacionEstablecimientoPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPage */])({
        segment: 'informacion-establecimiento/:idEstablecimiento'
    }),
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-informacion-establecimiento',template:/*ion-inline-start:"E:\progarmas\xampp\htdocs\proyectoMP\MaypiF\src\pages\informacion-establecimiento\informacion-establecimiento.html"*/'<!--\n\n  Generated template for the InformacionEstablecimientoPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <ion-title>informacion Establecimiento</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <ion-card>\n\n    <ion-row>\n\n      <ion-col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6>\n\n        <ion-card-header>\n\n          <ion-card-title>\n\n            <b>{{est.Nombre}}</b>\n\n          </ion-card-title>\n\n        </ion-card-header>\n\n        <ion-card-content>\n\n          <img src="img/iconoCategoria.png" class="imagenEstablecimiento" />\n\n          <br> {{est.Descripcion}}\n\n          <p>Calificacion: {{est.Calificacion}}\n\n            <ion-icon name="star"></ion-icon>\n\n          </p>\n\n        </ion-card-content>\n\n      </ion-col>\n\n      <ion-col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6>\n\n        <ion-card-content class="contentCard">\n\n          <h2><b>Ubicacion</b></h2>\n\n          <div showWhen="android,ios" #map id="map" name="map">\n\n          </div>\n\n          <div #mapa id="mapa" name="mapa" *ngIf="!esMovil">\n\n          </div>\n\n        </ion-card-content>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-card>\n\n</ion-content>'/*ion-inline-end:"E:\progarmas\xampp\htdocs\proyectoMP\MaypiF\src\pages\informacion-establecimiento\informacion-establecimiento.html"*/,
    }),
...
//# sourceMappingURL=informacion-establecimiento.js.map
